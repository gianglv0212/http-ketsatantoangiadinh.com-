<?php
global $wpie_user, $wpie_scheduled;

$get_schedules_list = wp_get_schedules();

$user_fields = $wpie_user->get_updated_user_fields();

$user_scheduled_export_list = $wpie_scheduled->get_user_scheduled_data();

$user_scheduled_import_list = $wpie_scheduled->get_user_import_scheduled_data();

$user_list = $wpie_user->get_user_list();

$log_list = $wpie_user->wpie_get_user_export_log();

$import_log_list = $wpie_user->wpie_get_user_import_log();

$total_users = count($user_list) < 2000 ? count($user_list) : "2000+";
?>
...
<div class="wpie_success_msg" wpie_premium_notice="<?php _e('( Premium Version Only )', WPIE_TEXTDOMAIN) ?>" wpie_wait_msg="<?php _e('Please Wait...', WPIE_TEXTDOMAIN) ?>"><?php _e('( Premium Version Only )', WPIE_TEXTDOMAIN) ?></div>
<div class="wpie-page-wrapper">
    <div class="container-fluid offset-10">
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="wpie-page-section-header wpie-red-section wpie-page-active-section" wpie-container="wpie-filter-wrapper">
                ...
                <div class="wpie-header-title-subtitle"><?php
                    echo $total_users . " ";
                    _e('Available users in store.', WPIE_TEXTDOMAIN);
                    ?>
                </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="wpie-page-section-header wpie-green-section" wpie-container="wpie-import-wrapper">
                ...
                <div class="wpie-header-title-content"><?php _e('Users', WPIE_TEXTDOMAIN); ?></div>
                <div class="wpie-header-title-subtitle"><?php _e('Import unlimited users.', WPIE_TEXTDOMAIN); ?></div>
    ...
    <div class="container-fluid offset-10 wpie-filter-wrapper  wpie-main-frm-wrapper  wpie-page-active-section-data">
        ...
        <form method="post" class="wpie-user-export-frm wpie-general-frm">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Filter By User ID / Username / Email', WPIE_TEXTDOMAIN); ?></div>
                        <div class="wpie-filter-title-text-sub-title">(<?php
                            _e('Total Users', WPIE_TEXTDOMAIN);
                            echo " : " . $total_users;
                            ?> )</div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_user_id[]" multiple="multiple" data-placeholder="<?php _e('Select User', WPIE_TEXTDOMAIN); ?>">
                            <?php
                            if (!empty($user_list)) {
                                foreach ($user_list as $new_user) {
                                    ?>
                                    <option value="<?php echo $new_user->ID; ?>"><?php echo '#' . $new_user->ID . ' ' . $new_user->display_name . ' ( ' . $new_user->user_email . ' )'; ?></option>
                                    <?php
                                }
                            }
                            ?>
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Users.', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Filter By User Role', WPIE_TEXTDOMAIN); ?></div>
                        <div class="wpie-filter-title-text-sub-title">(<?php
                            _e('Total User Role', WPIE_TEXTDOMAIN);
                            echo " : " . count(get_editable_roles());
                            ?> )</div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_user_role[]" multiple="multiple" data-placeholder="<?php _e('Select User Role', WPIE_TEXTDOMAIN); ?>">
                            <?php wp_dropdown_roles(); ?>

                        </select>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All User Roles.', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Filter By User Minimum Spend', WPIE_TEXTDOMAIN); ?></div>
                        <div class="wpie-filter-title-text-sub-title"></div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <input type="text" class="wpie-filter-input wpie_export_field_input_element" name="wpie_user_min_spend" placeholder="<?php _e('Enter Amount', WPIE_TEXTDOMAIN); ?>"/>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default', WPIE_TEXTDOMAIN); ?> : 0</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wpie-filter-btn-wrapper">
                    <a class="wpie-general-btn wpie-user-export-preview" ><?php _e('Preview', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-user-export" ><?php _e('Export', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-user-scheduled-export-data wpie-scheduled-save-export-data wpie-hidden" ><?php _e('Save Scheduled', WPIE_TEXTDOMAIN); ?></a>
                </div>
            </div>
        </form>
        <div class="wpie-filter-data-container wpie-datatable-wrapper-sample">
            <table class="wpie-product-filter-data wpie-datatable table table-striped table-bordered" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <?php
                        foreach ($user_fields as $new_product_cat_fields) {
                            foreach ($new_product_cat_fields as $user_fields_data)
                                if ($user_fields_data['field_display'] == 1) {
                                    echo '<th>' . $user_fields_data['field_title'] . '</th>';
                                }
                        }
                        ?>
                    </tr>
    ...
    <div class="container-fluid offset-10 wpie-import-wrapper wpie-main-frm-wrapper">
        <form method="post" class="wpie-user-import-frm wpie-general-frm">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('User Create / Update / Skip', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_user_create_method"  data-placeholder="<?php _e('Select user create option', WPIE_TEXTDOMAIN); ?>" >
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Note : Imported user is created, updated or skip if already exist.', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('User Search based on', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen" name="wpie_data_update_option"  data-placeholder="<?php _e('Select User Search Option', WPIE_TEXTDOMAIN); ?>" >
                            <option value="user_email"><?php _e('User Email', WPIE_TEXTDOMAIN); ?></option>
                            <option value="user_id"><?php _e('User ID', WPIE_TEXTDOMAIN); ?></option>
                        </select>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : User Email', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wpie-filter-btn-wrapper">
                    <a class="wpie-general-btn wpie-user-import" ><?php _e('Import', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-user-scheduled-import-data wpie-scheduled-save-export-data wpie-hidden" ><?php _e('Save Scheduled', WPIE_TEXTDOMAIN); ?></a>
                </div>
            </div>
        </form>
            ...
            <div class="wpie-advanced-option-wrapper">
                ...
                <div class="wpie-schedueld-list-data wpie-advanced-option-data">
                    <table class="wpie-product-scheduled-export wpie-scheduled-list table table-striped table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (!empty($user_scheduled_export_list)) { ?>
                                <?php foreach ($user_scheduled_export_list as $key => $value) { ?>
                                    <tr>
                                        <td><?php echo $key; ?></td>
                                        ...
                                        <td><?php echo date_i18n(get_option('date_format') . ' ' . get_option('time_format'), wp_next_scheduled('wpie_cron_scheduled_user_export', array($key))); ?></td>
                                        <td><?php echo '<div class="wpie-delete-cron-data wpie-delete-user-export-cron" cron_id=' . $key . '>DELETE</div>'; ?></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
            ...
            <div class="wpie-advanced-option-wrapper">
                ...
                <div class="wpie-schedueld-list-data wpie-advanced-option-data">
                    <table class="wpie-product-scheduled-import wpie-scheduled-import-list table table-striped table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (!empty($user_scheduled_import_list)) { ?>
                                <?php foreach ($user_scheduled_import_list as $key => $value) { ?>
                                    <tr>
                                        <td><?php echo $key; ?></td>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td><?php echo $value['wpie_scheduled_export_email_recipients']; ?></td>
                                        <td><?php echo date_i18n(get_option('date_format') . ' ' . get_option('time_format'), wp_next_scheduled('wpie_cron_scheduled_user_import', array($key))); ?></td>
                                        <td><?php echo '<div class="wpie-delete-cron-data wpie-delete-user-import-cron" cron_id=' . $key . '>DELETE</div>'; ?></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
    ...
    <div class="container-fluid offset-10 wpie-advanced-wrapper wpie-main-frm-wrapper">
        <div class="wpie-advanced-option-wrapper"> 
            ...
            <div class="wpie-advanced-option-data">
                <form class="wpie-user-fields-frm">
                    <?php
                    foreach ($user_fields as $new_product_cat_field) {
                    ...
                    <div class="wpie-advanced-option-data-container">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a class="wpie-general-btn wpie-user-settings-btn" ><?php _e('Save', WPIE_TEXTDOMAIN); ?></a>
                        </div>
                    </div>
                </form>
            </div>
