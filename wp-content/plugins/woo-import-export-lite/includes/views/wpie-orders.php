<?php
global $wpie_init, $wpie_product, $wpie_product_category, $wpie_scheduled, $wpie_order;
...
$order_fields = $wpie_order->get_updated_order_fields();

$order_scheduled_export_list = $wpie_scheduled->get_order_scheduled_data();

$order_scheduled_import_list = $wpie_scheduled->get_order_import_scheduled_data();

$log_list = $wpie_order->wpie_get_order_export_log();

$import_log_list = $wpie_order->wpie_get_order_import_log();

$total_orders = count($order_ids)<2000?count($order_ids):"2000+";
?>
...
<div class="wpie-page-wrapper">
    <div class="container-fluid offset-10">
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="wpie-page-section-header wpie-red-section wpie-page-active-section" wpie-container="wpie-filter-wrapper">
                ...
                <div class="wpie-header-title-subtitle"><?php
                    echo $total_orders . " ";
                    _e('Available orders in store.', WPIE_TEXTDOMAIN);
                    ?>
                </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="wpie-page-section-header wpie-green-section" wpie-container="wpie-import-wrapper">
                ...
                <div class="wpie-header-title-content"><?php _e('Orders', WPIE_TEXTDOMAIN); ?></div>
                <div class="wpie-header-title-subtitle"><?php _e('Import unlimited orders.', WPIE_TEXTDOMAIN); ?></div>
    ...
    <div class="container-fluid offset-10 wpie-filter-wrapper  wpie-main-frm-wrapper  wpie-page-active-section-data">
        ...
        <form method="post" class="wpie-order-export-frm wpie-general-frm">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Filter By Order Status', WPIE_TEXTDOMAIN); ?></div>
                        <div class="wpie-filter-title-text-sub-title">(<?php
                            _e('Total Status', WPIE_TEXTDOMAIN);
                            echo " : " . $total_orders;
                            ?> )</div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_order_status[]" multiple="multiple" data-placeholder="<?php _e('Select Order Status', WPIE_TEXTDOMAIN); ?>">
                            <?php
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Status', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    ...
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_product_ids[]" multiple="multiple" data-placeholder="<?php _e('Select Product', WPIE_TEXTDOMAIN); ?>">
                            <?php foreach ($product_list as $product_data) { ?>
                                <option value="<?php echo $product_data->ID; ?>"><?php echo '#' . $product_data->ID . ' ' . $product_data->post_title; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Filter By Order Id', WPIE_TEXTDOMAIN); ?></div>
                        <div class="wpie-filter-title-text-sub-title">(<?php
                            _e('Total Order', WPIE_TEXTDOMAIN);
                            echo " : " . $total_orders;
                            ?> )</div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen wpie_export_field_select_element" name="wpie_order_ids[]" multiple="multiple" data-placeholder="<?php _e('Select Order ID', WPIE_TEXTDOMAIN); ?>">
                            <?php foreach ($order_ids as $order_data) { ?>
                                <option value="<?php echo $order_data; ?>"><?php echo "#" . $order_data; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Order ID.', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wpie-filter-btn-wrapper">
                    <a class="wpie-general-btn wpie-order-export-preview" ><?php _e('Preview', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-order-export" ><?php _e('Export', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-order-scheduled-export-data wpie-scheduled-save-export-data wpie-hidden" ><?php _e('Save Scheduled', WPIE_TEXTDOMAIN); ?></a>
                </div>
            </div>
        </form>
        <div class="wpie-filter-data-container wpie-datatable-wrapper-sample">
            <table class="wpie-product-filter-data wpie-datatable table table-striped table-bordered" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <?php
                        foreach ($order_fields as $new_product_cat_fields) {
                            foreach ($new_product_cat_fields as $order_fields_data)
                                if ($order_fields_data['field_display'] == 1) {
                                    echo '<th>' . $order_fields_data['field_title'] . '</th>';
                                }
                        }
                        ?>
                    </tr>
    ...
    <div class="container-fluid offset-10 wpie-import-wrapper wpie-main-frm-wrapper">
        <form method="post" class="wpie-order-import-frm wpie-general-frm">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Order Create / Update / Skip', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie_export_field_select_element wpie-select-chosen" name="wpie_order_create_method"  data-placeholder="<?php _e('Select order create option', WPIE_TEXTDOMAIN); ?>" >
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Note : Imported order is created, updated or skip if already exist.', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    <div class="wpie-filter-title-text-wrapper">
                        <div class="wpie-filter-title-text"><?php _e('Order Search based on', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                    <div class="wpie-filter-input-wrapper">
                        <select class="wpie-select-chosen" name="wpie_data_update_option"  data-placeholder="<?php _e('Select Order Search Option', WPIE_TEXTDOMAIN); ?>" >
                            <option value="order_key"><?php _e('Order Key', WPIE_TEXTDOMAIN); ?></option>
                            <option value="order_id"><?php _e('Order ID', WPIE_TEXTDOMAIN); ?></option>
                        </select>
                    </div>
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : Order Key', WPIE_TEXTDOMAIN); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wpie-filter-btn-wrapper">
                    <a class="wpie-general-btn wpie-order-import" ><?php _e('Import', WPIE_TEXTDOMAIN); ?></a>
                    <a class="wpie-general-btn wpie-order-scheduled-import-data wpie-scheduled-save-export-data wpie-hidden" ><?php _e('Save Scheduled', WPIE_TEXTDOMAIN); ?></a>
                </div>
            </div>
        </form>
            ...
            <div class="wpie-advanced-option-wrapper">
                ...
                <div class="wpie-schedueld-list-data wpie-advanced-option-data">
                    <table class="wpie-product-scheduled-export wpie-scheduled-list table table-striped table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (!empty($order_scheduled_export_list)) { ?>
                                <?php foreach ($order_scheduled_export_list as $key => $value) { ?>
                                    <tr>
                                        <td><?php echo $key; ?></td>
                                        ...
                                        <td><?php echo '<div class="wpie-delete-cron-data wpie-delete-order-export-cron" cron_id=' . $key . '>DELETE</div>'; ?></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
            ...
            <div class="wpie-advanced-option-wrapper">
                ...
                <div class="wpie-schedueld-list-data wpie-advanced-option-data">
                    <table class="wpie-product-scheduled-import wpie-scheduled-import-list table table-striped table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (!empty($order_scheduled_import_list)) { ?>
                                <?php foreach ($order_scheduled_import_list as $key => $value) { ?>
                                    <tr>
                                        <td><?php echo $key; ?></td>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td><?php echo $value['wpie_scheduled_export_email_recipients']; ?></td>
                                        <td><?php echo date_i18n(get_option('date_format') . ' ' . get_option('time_format'), wp_next_scheduled('wpie_cron_scheduled_order_import', array($key))); ?></td>
                                        <td><?php echo '<div class="wpie-delete-cron-data wpie-delete-order-import-cron" cron_id=' . $key . '>DELETE</div>'; ?></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
    ...
    <div class="container-fluid offset-10 wpie-advanced-wrapper wpie-main-frm-wrapper">
        <div class="wpie-advanced-option-wrapper"> 
            ...
            <div class="wpie-advanced-option-data">
                <form class="wpie-order-fields-frm">
                    <?php
                    foreach ($order_fields as $new_product_cat_field) {
                    ...
                    <div class="wpie-advanced-option-data-container">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a class="wpie-general-btn wpie-order-settings-btn" ><?php _e('Save', WPIE_TEXTDOMAIN); ?></a>
                        </div>
                    </div>
                </form>
            </div>
