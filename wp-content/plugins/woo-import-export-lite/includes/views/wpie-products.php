            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Categories', WPIE_TEXTDOMAIN); ?> <span class="wpie_premium_feature"><?php _e('( Premium Feature )', WPIE_TEXTDOMAIN); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Products', WPIE_TEXTDOMAIN); ?> <span class="wpie_premium_feature"><?php _e('( Premium Feature )', WPIE_TEXTDOMAIN); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wpie-filter-inner-wrapper">
                    ...
                    <div class="wpie-filter-input-hint-wrapper">
                        <div class="wpie-filter-input-hint"><?php _e('Default : All Authors', WPIE_TEXTDOMAIN); ?> <span class="wpie_premium_feature"><?php _e('( Premium Feature )', WPIE_TEXTDOMAIN); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
