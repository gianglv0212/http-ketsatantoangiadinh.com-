...
<div class="phone-content content"><i class="fa fa-phone"></i><span class="contact-phone">1900 9491</span></div>
<div class="header-login col-sm-4 col-xs-4 col-sm-pull-4"> 
			<?php if ( class_exists( 'WooCommerce' ) && get_theme_mod( 'my-account-link', 1 ) == 1 ) { // Login Register  ?>
				<?php if ( is_user_logged_in() ) { ?>
					<a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" title="<?php _e( 'Tài khoản', 'e-shop' ); ?>"><?php _e( 'Tài khoản', 'e-shop' ); ?></a>
				<?php } else { ?>
					<a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" title="<?php _e( 'Đăng ký / Đăng nhập', 'e-shop' ); ?>"><?php _e( 'Đăng ký / Đăng nhập', 'e-shop' ); ?></a>
				<?php } ?> 
			<?php } ?>
		</div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-61120487-12"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-61120487-12');
</script>
