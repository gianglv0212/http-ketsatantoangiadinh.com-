...
<div id="getting_started" class="maxstore-tab-pane active">
  ...
  <div class="maxstore-video-tutorial">
	...
	<div class="maxstore-tab-pane-center">
		...
		<p><a href="<?php echo esc_url( 'http://demo.themes4wp.com/documentation/category/maxstore/' ); ?>" class="button button-primary"><?php esc_html_e( 'Read full documentation', 'maxstore' ); ?></a></p>
